...
export const adminNav: NavItem[] = [
  ...
  { label: "Recognition Studio", href: "/admin/recognition-library", icon: Library },
  { label: "Rewards", href: "/admin/rewards", icon: Package },
  { label: "Experience Studio", href: "/admin/settings", icon: Settings },
  { label: "Season Builder", href: "/admin/chapters", icon: CalendarDays },
  { label: "Experience Events", href: "/admin/events", icon: Megaphone },
...
export const launchReadinessChecklist = [
  ...
  { label: "Print Experience Cards", status: "Manager print run ready" },
