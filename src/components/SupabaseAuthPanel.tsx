...
export function SupabaseAuthPanel() {
  ...
  async function handleSubmit() {
    ...
    window.localStorage.setItem("experience-active-role", resolvedRole);
        ...
        <div>
          ...
          <p className="text-sm font-bold text-journey-steel">
            {mode === "reset_password"
              ...
              : mode === "create_account"
                ? "Create an employee account. Builder access can upgrade roles later."
                : "Sign in and Experience will open the right tools for your role."}
          </p>
        </div>
          ...
          {hasEnv
            ? mode === "reset_password"
              ...
              : mode === "create_account"
                ...
                : "Your account role controls which tools open after sign-in."
